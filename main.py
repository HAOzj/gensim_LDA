...
def main(short, long):
    ...
    lda.short_long_sim(short, long)


if __name__ == "__main__":
    optparser = OptionParser()
    optparser.add_option('-s', '--short', dest='short', help='短文本',
                         type="string", default="好的")
    optparser.add_option("-l", "--long", dest="long", help="长文本",
                         type="string", default="我的鬼鬼呦，你在说神马呢")
    (options, args) = optparser.parse_args()
    main(options.short, options.long)
